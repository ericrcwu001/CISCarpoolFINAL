...
public class AddLocationToAddVehicle extends AppCompatActivity implements OnMapReadyCallback {
    final private int padding = dpToPx(75); // offset from edges of the map in pixels
...
//                    Geocoder geocoder = new Geocoder(AddLocationToAddVehicle.this);
//                    try {
//                        addressList = geocoder.getFromLocationName(query, 1, HKLowerLeftLatLng.latitude, HKLowerLeftLatLng.longitude, HKUpperRightLatLng.latitude, HKUpperRightLatLng.longitude);
...
//                        map.moveCamera(cu);
//                    } catch (IOException e) {
//                        Log.d("error finding location", e.toString());
//                    }
